        ...
        <>
            ...
            <Drawer isOpen={drawerIsOpen} onClose={drawerOnClose} size={{ base: "sm", md: "md", lg: "lg" }}>
                ...
                <DrawerContent>
                    ...
                    <DrawerCloseButton onClick={() => drawerOnClose()} />
                    <DrawerBody>
                            ...
                            <Flex flexDirection={"column"} alignItems={"start"} justifyContent={"space-evenly"} h={"100%"}>
                                <Flex gap={"0.5rem"} alignItems={"center"}>
                                    <Heading size={"sm"}>
                                        ...
                                        From:{" "}
                                        <Link href={`${SEPOLIA_ADDRESS_LINK}${partyA}`} target="_blank">
                                ...
                                >
                                    ...
                                    <Box>
                                        ...
                                        <Flex overflowX={"clip"} flexDirection={"column"}>
                                            ...
                                            <Flex gap={"0.5rem"} alignItems={"center"}>
                                                <Link href={`${SEPOLIA_ADDRESS_LINK}${fromAddress}`} target="_blank">
                                ...
                                <Flex gap={"0.5rem"} alignItems={"center"}>
                                    <Heading size={"sm"}>
                                        ...
                                        To:{" "}
                                        <Link href={`${SEPOLIA_ADDRESS_LINK}${partyB}`} target="_blank">
                                ...
                                >
                                    ...
                                    <Box>
                                        ...
                                        <Flex overflowX={"clip"} flexDirection={"column"}>
                                            ...
                                            <Flex gap={"0.5rem"} alignItems={"center"}>
                                                <Link href={`${SEPOLIA_ADDRESS_LINK}${toAddress}`} target="_blank">
